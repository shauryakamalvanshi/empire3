    ...
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <Image width={1000} height={1000} alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src=""/>
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Satyam Samele</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <Image alt="team" width={1000} height={1000}  class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src=""/>
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Satyam Samele</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <Image alt="teahm" width={1000} height={1000}  class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src=""/>
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Sachin Chaturvedi</h2>
            <p class="text-gray-500">CFO</p>
          </div>
        </div>
      </div>
      {/* <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
