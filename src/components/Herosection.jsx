  ...
  return (
    ...
    <div className={styles.main}>
      ...
      <div className="relative  flex justify-evenly pt-24 max-lg:flex max-lg:flex-col bg-gradient-to-t from-cyan-200 to-cyan-400 max-h-full  ">
        ...
        <div className=" px-3 py-2 text-pink-500 uppercase bg-transparent border-2 border-pink-500 rounded-lg dark:text-white hover:bg-pink-500 hover:text-white text-lg">
